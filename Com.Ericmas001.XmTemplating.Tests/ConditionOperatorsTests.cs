...
namespace Com.Ericmas001.XmTemplating.Tests
{
    ...
    public class ConditionOperatorsTests
    {
        ...
        {
            EvaluateUtil.EvaluateBooleanCondition(true, "\"True\" OR \"True\" AND \"False\"", new Dictionary<string, string>());
            EvaluateUtil.EvaluateBooleanCondition(true, "\"True\" OR \"False\" AND \"True\"", new Dictionary<string, string>());
            EvaluateUtil.EvaluateBooleanCondition(true, "\"False\" OR \"True\" AND \"True\"", new Dictionary<string, string>());

            EvaluateUtil.EvaluateBooleanCondition(false, "(\"True\" OR \"True\") AND \"False\"", new Dictionary<string, string>());
            EvaluateUtil.EvaluateBooleanCondition(true, "(\"True\" OR \"False\") AND \"True\"", new Dictionary<string, string>());
            EvaluateUtil.EvaluateBooleanCondition(true, "(\"False\" OR \"True\") AND \"True\"", new Dictionary<string, string>());
        ...
        {
            EvaluateUtil.EvaluateBooleanCondition(true, "{V} > \"10\" OR {X} IN {Xs} OR {Y} + \"42\" < \"3\" * \"21\" - {Z}",
            ...
            EvaluateUtil.EvaluateBooleanCondition(false, "{V} > \"10\" OR {X} IN {Xs} OR {Y} + \"42\" < \"3\" * \"21\" - {Z}",
                new Dictionary<string, string>
                {
                    {"V", "3"},
                    {"X", "GoodBye"},
        ...
        {
            EvaluateUtil.EvaluateBooleanCondition(true, "{V} > \"10\" AND {X} IN {Xs} AND {Y} + \"42\" < \"3\" * \"21\" - {Z}",
                new Dictionary<string, string>
                {
                    {"V", "42"},
                    {"X", "Hello"},
            ...
            EvaluateUtil.EvaluateBooleanCondition(false, "{V} > \"10\" AND {X} IN {Xs} AND {Y} + \"42\" < \"3\" * \"21\" - {Z}",
                new Dictionary<string, string>
                {
                    {"V", "3"},
                    {"X", "Hello"},
