    ...
    public class TemplateTest : XmTemplateElement
    {
        public TemplateTest()
        {
            Elements = new AbstractTemplateElement[]
            {
                ...
                new StaticTemplateElement(this) {Content = Environment.NewLine + "This is some cool stuff: {CoolStuff}" + Environment.NewLine},
                new StaticTemplateElement(this) {Content = "<:BR:>"},
                new StaticTemplateElement(this) {Content = Environment.NewLine + "Cars:" + Environment.NewLine},
                new CarsEnumeratorTemplateElement(this),
                new StaticTemplateElement(this) {Content = Environment.NewLine},
                new StaticTemplateElement(this) {Content = "<:BR:>"},
                new StaticTemplateElement(this) {Content = Environment.NewLine + "Choices:  " + Environment.NewLine},
                new ChoicesEnumeratorTemplateElement(this),
                new StaticTemplateElement(this) {Content = Environment.NewLine},
                new StaticTemplateElement(this) {Content = "<:BR:>"},
                new StaticTemplateElement(this) {Content = Environment.NewLine + "People" + Environment.NewLine},
